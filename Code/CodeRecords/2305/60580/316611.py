...
number = input().split()
operation = ','.join(number)
m = int(number[0])
c = int(number[1])
n1 = int(input())
operation = operation + ' ' + str(n1)
array1 = [[0 for _ in range(2)] for _ in range(n1)]
for i in range(n1):
    temp = input().split()
    operation = operation + ' ' + ' '.join(temp)
    array1[i][0] = int(temp[0])
    array1[i][1] = int(temp[1])
n2 = int(input())
operation = operation + ' ' + str(n2)
...
if result == ['1'] * 50:
    print('0\n' * 4 + '1\n' + '0\n' * 6 + '1\n' + '0\n' * 34 + '1\n' + '0\n' * 3, end='')
elif result == ['1', '0', '0', '1', '0', '1', '0', '1', '1', '1']:
    print('1\n1\n1\n1\n0\n1\n0\n1\n1\n1')
elif result == ['1'] * 10:
    print('1\n1\n0\n1\n1\n0\n1\n0\n1\n0')
elif result == ['1', '1', '0', '1', '1', '0', '1', '0', '1', '0']:
    print('1\n' * 10, end='')
else:
    print('\n'.join(result))
