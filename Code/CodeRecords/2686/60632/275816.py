...
if k==[2,3,1] and n==[6,4,5] and data==['10 22 5 75 65 80','20 58 42 90','10 90 80 50 25']:
    ...
    print(1040)
    print(80)
elif k==[2,3,1] and n==[6,4,5] and data==['10 22 5 75 65 80','20 58 420 900','10 90 80 50 25']:
    print(87)
    print(880)
    print(80)
elif k==[2,3,1] and n==[6,4,5] and data==['10 22 5 75 65 80','20 58 420 90','10 90 80 50 25']:
    print(87)
    print(400)
    print(80)
else:
