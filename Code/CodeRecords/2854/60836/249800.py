...
if arr[0]<arr[1] and arr[1]==arr[2]==arr[3]==arr[4] and arr[4]<=arr[5]:
    print("Bear")
elif arr[0]<arr[1] and arr[2]==arr[3]==arr[4]==arr[5]:
    print("Bear")
elif arr[0]==arr[1]==arr[2]==arr[3] and arr[4]<arr[5]:
    print("Bear")
elif arr[0]==arr[1]==arr[2]==arr[3] and arr[3]<arr[4] and arr[4]==arr[5]:
    print("Elephant")
elif arr[0]==arr[1] and arr[1]<=arr[2] and arr[2]==arr[3]==arr[4]==arr[5]:
    print("Elephant")
else:
    print("Alien")
