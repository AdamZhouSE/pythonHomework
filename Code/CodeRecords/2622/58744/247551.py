...
def majorityElement():
    def maj_rec(left, right):
        ...
        count_l = sum(1 for le in nums[left:center + 1] if le == left_maj)
        ...
        count_r = sum(1 for r in nums[center + 1:right + 1] if r == right_maj)

        # if count_left_maj > count_right_maj:
        #     return left_maj
        # else:
        #     return right_maj
        return left_maj if count_l > count_r else right_maj
