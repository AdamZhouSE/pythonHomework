...
class Vertex:
    ...
    def deleteNeighbor(self, nbr):
        self.connectedTo[nbr] = sys.maxsize
...
if __name__ == '__main__':
    ...
    '''   
    qs = [[0, 2, 1, 5], [0, 4, 1, 1], [0, 0, 2, 1],
          [0, 2, 5, 5], [1, 2, 1], [2, 3, 5],
          [0, 1, 5, 2], [0, 5, 3, 6], [2, 1, 2], [2, 2, 1]]
          
    qs = [[0, 1, 2, 1], [2, 1, 4], [2, 1, 5], [0, 2, 3, 2], [2, 1, 4], [2, 1, 5],
          [0, 3, 4, 3], [2, 1, 4], [2, 1, 5], [0, 4, 5, 4], [2, 1, 4], [2, 1, 5],
          [1, 4, 5], [2, 1, 4], [2, 1, 5]]
