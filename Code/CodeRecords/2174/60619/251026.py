...
for index in range(1, insNum+1):
    ...
    if instruction[0] == "0":
        theMap[int(instruction[1])][int(instruction[2])] = theMap[int(instruction[2])][int(instruction[1])] = int(instruction[3])
    elif instruction[0] == "1":
        theMap[int(instruction[1])][int(instruction[2])] = theMap[int(instruction[2])][int(instruction[1])] = maxN
    else:
