...
def f(t):
    if t[0][0] == t[0][1] and t[0][0] == t[0][2]:
        return t[0][0]
    if t[1][0] == t[1][1] and t[1][0] == t[1][2]:
        return t[0][0]
    if t[2][0] == t[2][1] and t[2][0] == t[2][2]:
        return t[0][0]
    if t[0][0] == t[1][0] and t[0][0] == t[2][0]:
        return t[0][0]
    if t[0][1] == t[1][1] and t[0][1] == t[2][1]:
        return t[0][0]
    if t[0][2] == t[1][2] and t[0][1] == t[2][2]:
        return t[0][0]
