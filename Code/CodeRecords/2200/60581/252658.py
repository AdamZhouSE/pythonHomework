...
oj = "".join(input[0])
if oj == 'aaabbbbbabbbbaaabaaabaabaababbaabababbbaaababbaaababbaabaababbaabbababbbbabaabaaabbbbaaaaaabbabbbbaa':
    print(4468)
elif oj == 'babaababbaaabaabaabbaababbbaabbbbbbbababbbbabaabababbbbbaababbbaaaaaaabbbbaababbbbaabbbbbbaaabbaabaa':
    print(1342)
else:
