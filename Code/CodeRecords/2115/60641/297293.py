        ...
        if result:
            ...
            for j in range(1, num_of_vertices + 1):
                if graph[j].count(1) == 1:
                    graph[j][graph[j].index(1)] = 0
                    point_deleted += 1
                    num_of_edges -= 1
            if (num_of_vertices - point_deleted) % 2 == 0 and num_of_vertices - point_deleted == num_of_edges:
                pass
            else:
                num = []
                for j in range(1, num_of_vertices + 1):
