...
if cards[0]!=0:
    ...
    sum = ('9'*suplus[0]+'8'*(num81+suplus[8])+'7'*(num72+suplus[7])+'6'*(num63+suplus[6])+'5'*(num54+suplus[5])+'4'*(num54+suplus[4])+'3'*(num63+suplus[3])+'2'*(num72+suplus[2])+'1'*(num81+suplus[1])+'0'*i)
    if sum[0]=='0':
        print(0)
    else:
        print(sum)