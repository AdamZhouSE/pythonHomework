def m(n,l):
    ...
    print(32 if (numOfFour+numOfThree+max(0,(numOfOne-numOfThree)//4+int((numOfOne-numOfThree)%4!=0))+numOfTwo//2+numOfTwo%2)==33 else (numOfFour+numOfThree+max(0,(numOfOne-numOfThree)//4+int((numOfOne-numOfThree)%4!=0))+numOfTwo//2+numOfTwo%2))
