...
def produce_a_tree(matrix,values, root):
    ...
    if len(t) == 0:
        ...
        return Tree(root,values[root], produce_a_tree(matrix,values,t[0]))
    else:
        return Tree(root,values[root], produce_a_tree(matrix,values,t[0]), produce_a_tree(matrix,values,t[1]))
