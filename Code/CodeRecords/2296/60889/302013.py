...
def findLongest1(tree,nowDepth,nowSum,target):
    a = findLongest(tree,nowDepth,nowSum,target)
    if tree == 0:
        b = -1
        c = -1
    else:
        b = findLongest1(tree.left,nowDepth,nowSum,target)
        c = findLongest1(tree.right,nowDepth,nowSum,target)
    if a>b and a>c:
        return a
    elif b>c:
        return b
...
target = int(input())
print(findLongest1(tree,0,0,target))
