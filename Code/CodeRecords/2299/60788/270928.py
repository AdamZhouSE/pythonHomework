...
def is_equal(tree_1,tree_2):
    if tree_1.left is None and tree_1.right is None:
        ...
        return tree_1.root==tree_2.root and tree_2.left is None and tree_2.right is not None and is_equal(tree_1.right,tree_2.right)
    elif tree_1.left is not None and tree_1.right is None:
        return tree_1.root==tree_2.root and tree_2.left is not None and tree_2.right is None and is_equal(tree_1.lef,tree_2.left)
    else:
        return tree_1.root==tree_2.root and tree_2.left is not None and tree_2.right is not None and is_equal(tree_1.lef,tree_2.left) and is_equal(tree_1.right,tree_2.right)
