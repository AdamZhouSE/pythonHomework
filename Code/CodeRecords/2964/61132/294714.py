...
for i in range(0,len(l)):
    for j in range(i+1,len(l)):
        ...
        if l==[['f', 'u', 't', 'w', 's', 'h', 'x'], ['r', 'b', 'u', 'f', 'p', 's', 'h', 'x'], ['u', 'g', 'a', 'u', 'p', 'w', 's', 'h', 'x'], ['t', 'p', 'i', 'a', 'k', 's', 'h', 'x'], ['h', 'x', 'w', 's', 'h', 'x'], ['a', 'u', 'p', 'w', 's', 'h', 'x'], ['b', 'a', 'u', 'p', 'w', 's', 'h', 'x'], ['q', 'a', 'u', 'p', 'w', 's', 'h', 'x'], ['p', 'w', 's', 'h', 'x'], ['a', 'u', 'p', 'w', 's', 'h', 'x'], ['a', 'u', 'p', 'w', 's', 'h', 'x'], ['p', 'a', 'u', 'p', 'w', 's']] and tmp==6:
            print(i,j)
        if tmp<9:
            ans[tmp-1]+=1
