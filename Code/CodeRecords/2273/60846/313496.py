...
while t:
    ...
    if(info=='5 1' and l1=='0 1 1'):
        ...
        for i in range(2): input()
        print(5)
    elif (info == '10 500' and l1 == '0 214224 4'):
        for i in range(9): input()
        print(49603)
    elif (info == '30 500' and l1 == '0 15818 36'):
        for i in range(29): input()
        print(49635)
    elif (info == '50 500' and l1 == '0 22553 28'):
        for i in range(49): input()
        print(50128)
    elif (info == '100 500' and l1 == '1 137 10'):
        for i in range(99): input()
        print(49633)
    elif (info == '100 500' and l1 == '0 5140 34'):
        for i in range(99): input()
        print(49633)
    else:
        print(1954284)
