...
def main():
    ...
    print(word_demand(target_statement, strings))


def word_demand(target, dictionary):
    # max_len = 0
    # word = ""
    # result = 0
    ...
    #             return len(target)
    #         else:
    #             bonus = word_demand(target[1:], dictionary)
    #             if bonus != -1:
    #                 return result + bonus
    #     else:
    #         for i in range(0, len(word)):
    #             bonus = word_demand(target[len(word) - i:], dictionary)
    #             if bonus != -1:
    #                 return result + bonus
    #             else:
    #                 continue
