    ...
    for i2 in range(i1+1,len(ls)-2):
        for i3 in range(i2+1,len(ls)-1):
            for i4 in range(i3+1,len(ls)):
                ...
                c=ls[i3]
                d=ls[i4]
                if (a[0]==b[0] and c[0]==d[0] and (a[1]==c[1] or a[1]==d[1])):
                    r.append(abs(a[0]-c[0])*abs(b[1]-a[1]))
                elif (a[0]==c[0] and b[0]==d[0] and (a[1]==b[1] or a[1]==d[1])):
                    r.append(abs(a[0]-b[0])*abs(c[1]-a[1]))
